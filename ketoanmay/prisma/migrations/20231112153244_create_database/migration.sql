...
-- AddForeignKey
ALTER TABLE [dbo].[tChungTuGhiSo] ADD CONSTRAINT [FK_tChungTuGhiSo_tDanhMucChungTu] FOREIGN KEY ([cLoaiChungTu]) REFERENCES [dbo].[tDanhMucChungTu]([cMaLoaiChungTu]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[tChungTuGhiSo] ADD CONSTRAINT [FK_tChungTuGhiSo_tDanhMucKhachHang] FOREIGN KEY ([cMaKhachHangNo]) REFERENCES [dbo].[tDanhMucKhachHang]([cMaKhachHang]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE [dbo].[tChungTuGhiSoChiTiet] ADD CONSTRAINT [FK_tChungTuGhiSoChiTiet_tDanhMucTaiKhoan] FOREIGN KEY ([cTaiKhoanNo]) REFERENCES [dbo].[tDanhMucTaiKhoan]([cTaiKhoan]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[tChungTuKetChuyen] ADD CONSTRAINT [FK_tChungTuKetChuyen_tDanhMucChungTu] FOREIGN KEY ([cLoaiChungTu]) REFERENCES [dbo].[tDanhMucChungTu]([cMaLoaiChungTu]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE [dbo].[tChungTuKetChuyenChiTiet] ADD CONSTRAINT [FK_tChungTuKetChuyenChiTiet_tDanhMucTaiKhoan] FOREIGN KEY ([cTaiKhoanNo]) REFERENCES [dbo].[tDanhMucTaiKhoan]([cTaiKhoan]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[tChungTuNganHang] ADD CONSTRAINT [FK_tChungTuNganHang_tDanhMucChungTu] FOREIGN KEY ([cLoaiChungTu]) REFERENCES [dbo].[tDanhMucChungTu]([cMaLoaiChungTu]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[tChungTuNganHang] ADD CONSTRAINT [FK_tChungTuNganHang_tDanhMucKhachHang] FOREIGN KEY ([cMaKhachHang]) REFERENCES [dbo].[tDanhMucKhachHang]([cMaKhachHang]) ON DELETE NO ACTION ON UPDATE NO ACTION;
